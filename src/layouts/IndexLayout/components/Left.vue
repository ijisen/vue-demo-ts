<template>
    <div id="index-layout-left" :class="{'narrow': collapsed}">
        <div class="index-layout-left-logo">
        ...
        <div class="index-layout-left-menu">
            <sider-menu
              :collapsed="collapsed"
